  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="relative p-3 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 transition-all"
      >
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 top-full mt-2 w-96 bg-slate-800/95 backdrop-blur-xl rounded-xl border border-white/10 shadow-2xl z-50 max-h-[80vh] overflow-hidden"
            >
              {/* Header */}
                  ...
                  <div className="p-2">
                    {notifications.map((notification) => (
                      <motion.div
                        ...
                        exit={{ opacity: 0, x: -20 }}
                        className={`p-3 mb-2 rounded-lg border cursor-pointer transition-all hover:bg-white/5 ${
                            ...
                            <div className="flex items-center justify-between mt-2">
                              ...
                              {notification.action && (
                                ...
                                >
                                  ...
                                  {notification.action.url && <ExternalLink size={10} />}
                                </button>
                              )}
                            </div>
                          </div>
